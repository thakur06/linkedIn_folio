...
export default function Navbar({ cls }) {
  return (
    <nav
      className={`fixed  left-1/2 transform -translate-x-1/2 z-50 text-white  w-screen flex items-center h-14 backdrop-blur-3xl shadow-md lg:px-8 animate-fade-in ${cls}`}
    >
