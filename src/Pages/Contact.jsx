      ...
      <form className="my-8 " ref={form} onSubmit={sendEmail}>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <LabelInputContainer>
            ...
            <Input id="firstname" func={setname}  value={name} placeholder="Abhishek" name="user_name" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
            <Label htmlFor="lastname">Last name</Label>
            <Input id="lastname" func={setlname}  value={lname}  placeholder="Rajput" type="text" />
          </LabelInputContainer>
        </div>
        <LabelInputContainer className="mb-4">
          <Label htmlFor="email">Email Address</Label>
          <Input id="email" func={setemailAddress}  value={emailAddress}  placeholder="Your email@gmail.com"name="user_email" type="email" />
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
